...
You have to design & build the backend for the application and the ability for the users to register, check medicines, place orders etc.
...
https://github.com/azaylamba/netmeds 
